...
function Shome() {
  ...
  const data = [
    { name: "Items", value: totalItems, fill: "#5A99D3" },
    { name: "Orders", value: totalOrders, fill: "#00072D" },
  ];
    ...
    >
      ...
      <div className="container mt-5">
        <h3
          ...
          style={{ color: "#1A2E45", fontWeight: 600 }}
        >
          Dashboard
        </h3>
        <Card
        ...
        >
          <div className="d-flex justify-content-around align-items-center p-4">
            <Link to="/myproducts" style={{ textDecoration: "none" }}>
              <div
                className="dashboard-item w-64 h-36"
                style={{
              ...
              >
                Items <br />{" "}
                <span style={{ fontSize: "2.5rem", color: "#0046A1" }}>
                  {totalItems}
                </span>
              </div>
            </Link>
            <Link to="/orders" style={{ textDecoration: "none" }}>
              ...
              >
                Total Orders <br />{" "}
                <span style={{ fontSize: "2.5rem", color: "#00072D" }}>
                  {totalOrders}
                </span>
              </div>
            </Link>
          ...
          >
            <BarChart width={500} height={300} data={data}>
              ...
              <YAxis stroke="#1A2E45" />
              <Tooltip
                contentStyle={{ backgroundColor: "#FFFFFF", color: "#1A2E45" }}
              />
              <Legend />
